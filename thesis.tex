...
and~$q = q_0$ which is initial state defined in~the~description of~the~given machine. If~a~run is
...
which required putting a large part of a~program logic into appropriate state names, so it is important
...
\begin{itemize}
  ...
  \item \texttt{-d} or \texttt{--direct} directly runs translated code. If input
      ...
      be provided as a command \texttt{./full\_pipeline -d outdir/aaa} \todo{Dopisać jak wykrywa język}
...
\todo{Dopisać słowną analizę tabelki poniżej.}
\todo{dopisać na jakiej maszynie uruchamiane.}
...
System:
Linux thinkpad 4.15.0-45-generic \#48-Ubuntu SMP Tue Jan 29 16:28:13 UTC 2019 x86\_64 x86\_64 x86\_64 GNU/Linux
...
\hline
%\texttt{hello.bf} & \# & 111 & 112 & 123 & 5\,175\,355 & ?\\
\texttt{hello.bf} & \# & 111 & 112 & 123 & 5.2 M & ?\\
 & {\footnotesize{RT}} & 0.01 s & 0.00 s & 0.01 s & $\infty$ & $\infty$ \\
 & {\footnotesize{TT}} & 0.01 s & 0.01 s & 249.84 s & ? & --- \\
\hline
%\texttt{hello3.bf} & \# & 193 & 205 & 209 & 1\,568\,779 & ?\\
\texttt{hello3.bf} & \# & 193 & 205 & 209 & 1.6 M & ?\\
 & {\footnotesize{RT}} & 0.01 s & 0.01 s & 0.01 s & 80.34 s & $\infty$ \\
 & {\footnotesize{TT}} & 0.01 s & 0.01 s & 94.48 s & ? & --- \\
\hline
%\texttt{hello4.xbf} & \# & 26 & 27 & 28 & 41\,761 & 365\,202\\
\texttt{hello4.xbf} & \# & 26 & 27 & 28 & 42 k & 36 k\\
 & {\footnotesize{RT}} & 0.00 s & 0.00 s & 0.00 s & 0.04 s & 1.41 s \\
 & {\footnotesize{TT}} & 0.00 s & 0.00 s & 5.22 s & 4.71 s & --- \\
\hline
%\texttt{to\_lower.bf} & \# & 34 & 35 & 36 & 385\,189 & ?\\
\texttt{to\_lower.bf} & \# & 34 & 35 & 36 & 0.4 M & ?\\
 & {\footnotesize{RT}} & 0.01 s & 0.01 s & 0.00 s & 0.41 s & $\infty$ \\
 & {\footnotesize{TT}} & 0.00 s & 0.01 s & 21.40 s & ? & --- \\
\hline
%\texttt{add\_digits.bf} & \# & 69 & 70 & 77 & 3\,894\,442 & ?\\
\texttt{add\_digits.bf} & \# & 69 & 70 & 77 & 3.9 M & ?\\
 & {\footnotesize{RT}} & 0.01 s & 0.01 s & 0.01 s & 5.37 s & $\infty$ \\
 & {\footnotesize{TT}} & 0.01 s & 0.01 s & 181.75 s & ? & --- \\
\hline
%\texttt{inout.bf} & \# & 2 & 3 & 4 & 335\,877 & ?\\
\texttt{inout.bf} & \# & 2 & 3 & 4 & 0.3 M & ?\\
 & {\footnotesize{RT}} & 0.01 s & 0.01 s & 0.01 s & 0.03 s & $\infty$ \\
 & {\footnotesize{TT}} & 0.01 s & 0.01 s & 14.99 s & ? & --- \\
\hline
%\texttt{simple.tm} & \# & --- & 8 & 11 & 345\,407 & ?\\
\texttt{simple.tm} & \# & --- & 8 & 11 & 0.3 M & ?\\
 & {\footnotesize{RT}} & --- & 0.01 s & 0.01 s & 0.07 s & $\infty$ \\
 & {\footnotesize{TT}} & --- & 0.00 s & 14.57 s & ? & --- \\
\hline
%\texttt{rotate.tm} & \# & --- & 14 & 18 & 1\,596\,442 & ?\\
\texttt{rotate.tm} & \# & --- & 14 & 18 & 1.6 M & ?\\
 & {\footnotesize{RT}} & --- & 0.01 s & 0.01 s & 0.24 s & $\infty$ \\
 & {\footnotesize{TT}} & --- & 0.01 s & 71.92 s & ? & --- \\
\hline
...
to Brainfuck (\cite{in-person}). Together these two works give full
proof of the theoretical concept of equivalence modern languages and $2$ Counter
Machine.
...
Exponential growth is dangerous (which is not surprising) and limits our implementation.
...
to the current shape of ASCII table, to it is not that simple to make such a remapping,
...
\begin{itemize}
  \item Extending from the left side of the pipeline -- translations from any modern
  ...
  \item Adding ASCII mapping that is attached to original source code -- that
      would allow creating codes in slight modifications of Brainfuck that
      would be more efficient in the endpoint source code.
\end{itemize}
