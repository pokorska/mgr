...
\begin{figure}
  \begin{subfigure}[b]{0.4\textwidth}
    ...
    \begin{tikzpicture}[stack/.style={rectangle split, rectangle split parts=#1,draw, anchor=center}]
      ...
      \draw [->, >=stealth] (1,0) -- (4,0) node [midway, above, sloped] (TextNode) {\textbf{pop}};
    \end{tikzpicture}
  ...
  \begin{subfigure}[b]{0.6\textwidth}
    ...
    \begin{tikzpicture}[stack/.style={rectangle split, rectangle split parts=#1,draw, anchor=center}]
      ...
      \draw [->,>=stealth,postaction={decorate,decoration={text along path,text align=center,text={|\myshift|divide by {$\bar{N}$}}}}]
      (0.5,0.1) to[bend left=45] (4.5,0.1);

      \def\myshift#1{\raisebox{.5ex}}
      \draw [<-,>=stealth,postaction={decorate,decoration={text along path,text align=center,text={|\myshift|copy}}}]
