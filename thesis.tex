...
\englishabstract{
A Two Counter Machine is an abstract machine that consists of a finite set of states, two counters and input/output counters.
A well-known theorem states that any program written in a modern programming language can be translated into a Two Counter Machine. 
In this thesis, I present a tool I developed for automatic translation from a modern
programming language (Brainfuck) to a Counter Machine with two counters.
The tool can also produce programs for Four Counter Machines and Pushdown
Automata with two stacks, and execute a program written in any of these languages.
}
