...
alphabet by $3$, i.e. given \texttt{a} will print \texttt{d}, for \texttt{A}
...
Code may be easily changes into a~rotation by any number -- it is enough
...
change & $ -> change1 (ORIG_LEFT + BLANK) NOTHING
change & ALL -> change1 (PREV(ORIG_LEFT) + ORIG_RIGHT) NOTHING
...
\begin{table}[]
\centering
\caption{Size of translated programs\\
Translation time\\
Running time
}
\label{t:my-label}
